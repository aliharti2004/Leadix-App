...
<body>
    ...
    <div class="invoice-details">
        <div class="left">
            <h2>Bill To</h2>
            <p><strong><?php echo e($invoice->deal->lead->title ?? 'N/A'); ?></strong></p>
            <p><?php echo e($invoice->deal->lead->contact_name ?? 'N/A'); ?></p>
            <p><?php echo e($invoice->deal->lead->email ?? ''); ?></p>
            <p><?php echo e($invoice->deal->lead->phone ?? ''); ?></p>
        </div>
    ...
    <table class="items-table">
        ...
        <tbody>
            ...
            <?php else: ?>
                <tr>
                    <td><?php echo e($invoice->deal->title ?? 'Service'); ?></td>
    ...
    <div class="totals">
        <table>
            <tr>
                ...
                <td class="amount">$<?php echo e(number_format($invoice->total, 2)); ?></td>
            </tr>
            <tr class="total-row">
    ...
    <div class="footer">
        ...
        <p>Generated on <?php echo e(now()->format('M d, Y \a\t h:i A')); ?></p>
        <p>© <?php echo e(now()->year); ?> LeadiX - Revenue Operations Platform</p>
    </div>

</body>

</html><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/invoices/pdf.blade.php ENDPATH**/ ?>