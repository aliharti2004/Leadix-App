...
<?php $__env->startSection('header', 'Edit Lead'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            ...
            <h2 class="text-2xl font-black text-white">Edit Lead</h2>
            <p class="text-gray-400 mt-1">Update lead information</p>
        </div>

        
        <form action="<?php echo e(route('leads.update', $lead)); ?>" method="POST"
            class="glass-card rounded-2xl p-8 border border-white/10">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="title" value="<?php echo e(old('title', $lead->title)); ?>" required
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="contact_name" value="<?php echo e(old('contact_name', $lead->contact_name)); ?>"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="email" name="email" value="<?php echo e(old('email', $lead->email)); ?>"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="phone" value="<?php echo e(old('phone', $lead->phone)); ?>"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="company" value="<?php echo e(old('company', $lead->company)); ?>"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" name="job_title" value="<?php echo e(old('job_title', $lead->job_title)); ?>"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
                        placeholder="CEO">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="source"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition">
                        <option value="website" <?php echo e(old('source', $lead->source) == 'website' ? 'selected' : ''); ?>>Website
                        </option>
                        <option value="referral" <?php echo e(old('source', $lead->source) == 'referral' ? 'selected' : ''); ?>>Referral
                        </option>
                        <option value="cold_call" <?php echo e(old('source', $lead->source) == 'cold_call' ? 'selected' : ''); ?>>Cold
                            Call</option>
                        <option value="linkedin" <?php echo e(old('source', $lead->source) == 'linkedin' ? 'selected' : ''); ?>>LinkedIn
                        </option>
                        <option value="event" <?php echo e(old('source', $lead->source) == 'event' ? 'selected' : ''); ?>>Event</option>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="status"
                        class="w-full bg-black/30 text-white border border-white/10 rounded-xl px-4 py-3 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition">
                        <option value="new" <?php echo e(old('status', $lead->status) == 'new' ? 'selected' : ''); ?>>New</option>
                        <option value="contacted" <?php echo e(old('status', $lead->status) == 'contacted' ? 'selected' : ''); ?>>
                            Contacted</option>
                        <option value="qualified" <?php echo e(old('status', $lead->status) == 'qualified' ? 'selected' : ''); ?>>
                            Qualified</option>
                        <option value="nurturing" <?php echo e(old('status', $lead->status) == 'nurturing' ? 'selected' : ''); ?>>
                            Nurturing</option>
                        <option value="disqualified" <?php echo e(old('status', $lead->status) == 'disqualified' ? 'selected' : ''); ?>>
                            Disqualified</option>
                    </select>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="estimated_value"
                            value="<?php echo e(old('estimated_value', $lead->estimated_value)); ?>" step="0.01" min="0"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="notes" rows="4"
                        ...
                        placeholder="Add any additional notes or context about this lead..."><?php echo e(old('notes', $lead->notes)); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/leads/edit.blade.php ENDPATH**/ ?>