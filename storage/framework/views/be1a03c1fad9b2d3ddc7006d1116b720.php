...
<div class="glass-card rounded-2xl p-6 border border-white/10 hover:border-orange-500/30 transition-all group">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-white"><?php echo e($myActiveLeads ?? '0'); ?></h2>
...
<div class="glass-card rounded-2xl p-6 border border-white/10 hover:border-orange-500/30 transition-all group">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-white"><?php echo e($dealsInNegotiation ?? '0'); ?></h2>
...
<div class="glass-card rounded-2xl p-6 border border-white/10 hover:border-orange-500/30 transition-all group">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-white">$<?php echo e(number_format($weightedForecast ?? 0, 0)); ?></h2>
...
<div class="glass-card rounded-2xl p-6 border border-white/10 hover:border-orange-500/30 transition-all group">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-white"><?php echo e($winRate ?? '0%'); ?></h2>
...
</style><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/dashboard/partials/sales-stats.blade.php ENDPATH**/ ?>