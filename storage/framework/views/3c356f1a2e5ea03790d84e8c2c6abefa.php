    ...
    <div x-data="teamSettings()" class="p-6">
            ...
            <div class="lg:col-span-2 space-y-6">
                                    ...
                                    <tr class="group hover:bg-white/5 transition-colors">
                                        <td class="py-4 pl-2">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="text-white font-bold text-sm"><?php echo e($member->name); ?></p>
                                                    <p class="text-gray-500 text-xs"><?php echo e($member->email); ?></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-4">
                                            <span
                                                class="px-2 py-1 rounded-md text-xs font-bold uppercase
                                                                                        <?php echo e($member->role === 'admin' ? 'bg-orange-500/20 text-orange-400 border border-orange-500/30' : 'bg-blue-500/20 text-blue-400 border border-blue-500/30'); ?>">
                                        ...
                                        <td class="py-4 text-right pr-2">
                                            <?php if(auth()->id() !== $member->id): ?>
                                                <button type="button" @click="openDeleteModal(<?php echo e($member->id); ?>)"
                ...
                <?php if($pendingInvitations->count() > 0): ?>
                    <div class="glass-card p-6 rounded-2xl relative overflow-hidden">
                        ...
                        <div class="space-y-3">
                            <?php $__currentLoopData = $pendingInvitations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $invite): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-white/5 rounded-xl border border-white/5">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p class="text-white font-bold text-sm"><?php echo e($invite->email); ?></p>
                                            <p class="text-gray-500 text-xs capitalize flex items-center gap-1">
                                                <?php echo e($invite->role); ?> • Sent <?php echo e($invite->created_at->diffForHumans()); ?>

                                            </p>
                                        </div>
                                    </div>

                                    <form method="POST" action="<?php echo e(route('invitations.destroy', $invite->id)); ?>">
                                        <?php echo csrf_field(); ?>
        ...
        <div x-show="modalOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
            ...
            <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                ...
                <form action="<?php echo e(route('invitations.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="space-y-4">
                        <div>
...
<?php endif; ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/settings/team.blade.php ENDPATH**/ ?>