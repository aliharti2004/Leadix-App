...
<?php $component->withAttributes([]); ?>
    ...
    <div class="mb-8 flex flex-col md:flex-row md:items-center justify-end gap-4">
        <select onchange="window.location.href = '?range=' + this.value"
            ...
            <option value="6_months" <?php echo e(request('range') == '6_months' ? 'selected' : ''); ?>>Last 6 Months</option>
            <option value="12_months" <?php echo e(request('range') == '12_months' ? 'selected' : ''); ?>>Last 12 Months</option>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div class="stat-card rounded-2xl p-6">
            ...
            <p class="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-amber-500 text-3xl font-black">
                $<?php echo e(number_format($stats['balance'], 0)); ?>

            </p>
            <p
                class="<?php echo e($stats['growth'] >= 0 ? 'text-green-400 bg-green-500/10' : 'text-red-400 bg-red-500/10'); ?> text-xs mt-2 font-medium inline-block px-2 py-1 rounded-lg">
                <?php echo e($stats['growth'] >= 0 ? '+' : ''); ?><?php echo e(number_format($stats['growth'], 1)); ?>% vs last month
            </p>
        </div>
        ...
        <div class="stat-card rounded-2xl p-6">
            ...
            <p class="text-white text-3xl font-black">$<?php echo e(number_format($stats['income'], 0)); ?></p>
        ...
        <div class="stat-card rounded-2xl p-6">
            ...
            <p class="text-white text-3xl font-black">$<?php echo e(number_format($stats['expenses'], 0)); ?></p>
        ...
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-white font-black text-lg">
                ...
                <span class="text-gray-500 text-sm font-medium ml-2">
                    (<?php echo e(request('range') == '12_months' ? 'Last 12 Months' : (request('range') == 'this_year' ? 'This Year' : 'Last 6 Months')); ?>)
                </span>
            </h3>
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                    <div>
                        ...
                        <p class="text-white text-xl font-black">$<?php echo e(number_format($forecast['30'], 0)); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                    <div>
                        ...
                        <p class="text-white text-xl font-black">$<?php echo e(number_format($forecast['60'], 0)); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                    <div>
                        ...
                        <p class="text-white text-xl font-black">$<?php echo e(number_format($forecast['90'], 0)); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs"><?php echo e($receivables['pending_count']); ?> invoices</p>
                        </div>
                    </div>
                    <p class="text-white font-black text-lg">$<?php echo e(number_format($receivables['pending_amount'], 0)); ?></p>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white/5 rounded-xl border border-white/5">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs text-red-400"><?php echo e($receivables['overdue_count']); ?> invoices
                            </p>
                        </div>
                    </div>
                    <p class="text-red-400 font-black text-lg">$<?php echo e(number_format($receivables['overdue_amount'], 0)); ?>
                ...
                <div class="pt-4 border-t border-white/5 mt-2">
                    <div class="flex items-center justify-between">
                        ...
                        <p
                            ...
                            $<?php echo e(number_format($receivables['total_outstanding'], 0)); ?>
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Income',
                            data: <?php echo json_encode($chart['income'], 15, 512) ?>,
                            borderColor: '#10b981',
                        ...
                        {
                            label: 'Expenses',
                            data: <?php echo json_encode($chart['expenses'], 15, 512) ?>,
                            borderColor: '#ef4444',
...
<?php endif; ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/cashflow/index.blade.php ENDPATH**/ ?>