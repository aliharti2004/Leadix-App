    ...
    <div x-data="contactManager()" class="p-6">
                                ...
                                <tr class="group hover:bg-white/5 transition-colors">
                                    <td class="py-4 pl-2">
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div>
                                                <p class="text-white font-bold text-sm"><?php echo e($contact->name); ?></p>
                                                <p class="text-gray-500 text-xs"><?php echo e($contact->email); ?></p>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="py-4">
                                        <div class="text-sm text-gray-300 font-medium"><?php echo e($contact->job_title ?? '-'); ?></div>
                                        <?php if($contact->linkedin_url): ?>
                                            <a href="<?php echo e($contact->linkedin_url); ?>" target="_blank"
                                    ...
                                    <td class="py-4 text-right pr-2">
                                        <div class="flex items-center justify-end gap-2">
                                            <button type="button" @click="editContact(<?php echo e($contact); ?>)"
                                            ...
                                            <button type="button" @click="openDeleteModal(<?php echo e($contact->id); ?>)"
        ...
        <div x-show="modalOpen" class="fixed inset-0 z-50 flex items-center justify-center p-4" style="display: none;">
            ...
            <div x-show="modalOpen" x-transition:enter="transition ease-out duration-300"
                ...
                <form :action="isEditing ? '/contacts/' + form.id : '<?php echo e(route('contacts.store')); ?>'" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/contacts/index.blade.php ENDPATH**/ ?>