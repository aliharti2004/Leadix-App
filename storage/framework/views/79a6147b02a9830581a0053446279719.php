...
<?php $__env->startSection('content'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-6">
        ...
        <div class="stat-card rounded-2xl p-5">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-white">$<?php echo e(number_format($totalPipeline ?? 0)); ?></h3>
        ...
        <div class="stat-card rounded-2xl p-5">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-white">$<?php echo e(number_format($monthlyRecurringRevenue ?? 0)); ?></h3>
                <p class="text-xs text-green-500 font-bold mt-1">↑ <?php echo e($wonDeals ?? 0); ?> deals closed</p>
            </div>
        </div>
        ...
        <div class="stat-card rounded-2xl p-5">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-white"><?php echo e($activeCustomers ?? 0); ?></h3>
        ...
        <div class="stat-card rounded-2xl p-5">
            ...
            <div>
                ...
                <h3 class="text-3xl font-black text-red-500">$<?php echo e(number_format($overdueReceivables ?? 0)); ?></h3>
                <p class="text-xs text-red-400 font-bold mt-1"><?php echo e($overdueInvoices ?? 0); ?> invoices</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const pipelineData = <?php echo json_encode($pipelineChartData, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/dashboard/admin.blade.php ENDPATH**/ ?>