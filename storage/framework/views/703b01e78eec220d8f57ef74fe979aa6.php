...
<?php $component->withAttributes([]); ?>
    <div class="space-y-8">
        ...
        <section class="glass-card p-8 rounded-2xl">
            ...
            <form method="post" action="<?php echo e(route('settings.profile.update')); ?>" class="space-y-6 max-w-xl">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
        ...
        <section class="glass-card p-8 rounded-2xl">
            ...
            <form method="post" action="<?php echo e(route('settings.password.update')); ?>" class="space-y-6 max-w-xl">
                <?php echo csrf_field(); ?>
                <?php echo method_field('put'); ?>
...
<?php endif; ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/settings/profile.blade.php ENDPATH**/ ?>