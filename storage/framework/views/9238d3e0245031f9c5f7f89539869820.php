...
<?php $__env->startSection('header', 'Reports & Analytics'); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="stat-card rounded-2xl p-6 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-3xl font-black text-white">$<?php echo e(number_format($totalRevenue, 2)); ?></h3>
            ...
            <div class="stat-card rounded-2xl p-6 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-3xl font-black text-white">$<?php echo e(number_format($pipelineValue, 2)); ?></h3>
            ...
            <div class="stat-card rounded-2xl p-6 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-3xl font-black text-white"><?php echo e($winRate); ?>%</h3>
            ...
            <div class="stat-card rounded-2xl p-6 relative overflow-hidden group">
                ...
                <div class="relative z-10">
                    ...
                    <h3 class="text-3xl font-black text-white"><?php echo e($activeDeals); ?></h3>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const dealsData = <?php echo json_encode($dealsByStage, 15, 512) ?>;
            const revenueData = <?php echo json_encode($revenueTrend, 15, 512) ?>;
            const invoiceData = <?php echo json_encode($invoicesByStatus, 15, 512) ?>;
            const monthlyData = <?php echo json_encode($monthlyPerformance, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\dell\.gemini\antigravity\scratch\leadix-app\resources\views/reports/index.blade.php ENDPATH**/ ?>