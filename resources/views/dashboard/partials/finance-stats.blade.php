...
<div class="glass-card rounded-2xl p-6 border border-white/10">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-600">
            ${{ number_format($totalCashCollected ?? 66500, 0) }}
        </h2>
...
<div class="glass-card rounded-2xl p-6 border border-white/10">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-white">{{ $pendingInvoicesCount ?? 14 }}</h2>
        <span class="ml-2 text-sm font-medium text-gray-400">Value:
            ${{ number_format($pendingInvoicesValue ?? 42750, 0) }}</span>
    </div>
</div>
...
<div class="glass-card rounded-2xl p-6 border border-white/10">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-white">{{ $averageDaysToPay ?? 42 }}</h2>
...
<div class="glass-card rounded-2xl p-6 border border-white/10">
    ...
    <div class="flex items-baseline">
        <h2 class="text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-600">
            ${{ number_format($totalTaxLiability ?? 66000, 0) }}
        </h2>
